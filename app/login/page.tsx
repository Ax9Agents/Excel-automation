      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-700 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-12">
            ...
            <h1 className="text-3xl font-bold text-white">Invoice Generator Pro</h1>
          </div>
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100">
                  Automatically generate batch numbers, dates, botanical names, COA, and MSDS using advanced AI
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100">
                  Upload any Excel file and AI will intelligently extract all invoice data
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100">
                  Invoices automatically saved to your Google Drive with full version history
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 text-blue-100 text-sm">
          © 2025 Invoice Generator Pro. All rights reserved.
        </div>
      </div>
        ...
        <div className="bg-white p-10 rounded-2xl shadow-2xl max-w-md w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Sign in to generate professional IGST invoices
            </p>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-white border-2 border-gray-300 text-gray-700 font-semibold py-4 px-6 rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed group"
          >
            {loading ? (
              <>
